...
{
    return "HE3-V3-V1-ANALYTIC-20260819-R5";
}
    ...
    CalibrationV3Report* report)
{
    ...
    for (int iter = 0; iter < maxIterations; ++iter)
    {
        ...
        // V1 core: solve J_active * delta_active ~= residual by pseudoinverse.
        LinearSolveInfo solveInfo;
        const VectorXd deltaJoint = PseudoInverseSolve(Jactive, currentState.residual, solveInfo);
